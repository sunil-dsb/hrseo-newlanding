    ...
    <section className="relative flex items-center pt-48 pb-20 md:px-6">
      <div className="max-w-5xl 2xl:max-w-7xl container-4k mx-auto w-full px-4">
        ...
        <h1 className="text-6xl sm:text-7xl md:text-[6.5rem] min-[2560px]:text-[10.3rem] font-bold tracking-tighter mb-12 md:animate-fade-in">
          ...
          <TextHighlight className="font-bold relative z-20">
            {t("titleHighlight1")}
          </TextHighlight>
          <br />
          ...
          <BlurFade delay={0.4}>
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                >
                  <span
                    className="font-bold text-black text-sm min-[2560px]:text-base"
                    aria-hidden="true"
                  >
                    4.9/5
                  </span>
            ...
            <div className="inline-block">
              <Link href="/auth/register">
                <ButtonSlide
                  ...
                  icon={
                    <span
                      className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-transparent transition-all duration-300 group-hover:bg-white"
                      aria-hidden="true"
                    >
            ...
            <div className="inline-block">
              <Link href="/demo">
                <ButtonSlide
                  ...
                  icon={
                    <span
                      className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-transparent transition-all duration-300 group-hover:bg-[#F15A29]"
                      aria-hidden="true"
                    >
