      ...
      <div className="max-w-5xl 2xl:max-w-7xl mx-auto w-full">
        <div className="text-center mb-16 space-y-4">
          ...
          <div className="flex items-center justify-center gap-1 mb-6">
            ...
            <svg
              className="w-8 h-8 text-zinc-400 fill-current transform -scale-x-100"
              viewBox="0 0 18 31"
              xmlns="http://www.w3.org/2000/svg"
              aria-hidden="true"
            >
        ...
        >
          <button
            ...
            className={`btn-anim relative overflow-hidden font-bold text-sm transition-all duration-300 w-32 ${
          ...
          >
            ...
            <div
              className="span-hidden absolute inset-0 py-3"
              aria-hidden="true"
            >
              <span>Monthly</span>
            </div>
          ...
          <div className="relative">
            ...
            >
              <div className="relative flex flex-col items-center">
                ...
                <p
                  className="text-[#F15A29] font-bold text-sm leading-tight text-center transform rotate-6"
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-6 px-4 md:px-8">
          <BlurFade delay={0.1}>
            <div className="bg-white rounded-2xl p-8 sm:p-10 h-full flex flex-col relative overflow-hidden group border border-zinc-200 shadow-sm transition-all hover:shadow-lg hover:shadow-black/5">
              <div className="flex justify-between items-start mb-6">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <div className="text-zinc-500 text-sm font-medium min-[2560px]:text-base">
                    /month
                    {billingCycle === "yearly" && (
                      <span className="block text-xs text-zinc-400 font-normal min-[2560px]:text-sm">
                        billed yearly
                      </span>
                    )}
                  </div>
              ...
              <div className="mb-8">
                <h3 className="text-xl font-bold mb-1 min-[2560px]:text-2xl">
                  Professional
                </h3>
                <p className="text-zinc-500 text-sm min-[2560px]:text-base">
                  Ideal for growing businesses.
                </p>
              </div>

              <Link href="/auth/register" className="w-full block mb-10">
                <ButtonSlide
                  as="div"
                  variant="light"
              ...
              <div className="space-y-4 mb-auto">
                <p className="text-sm font-medium text-zinc-900 min-[2560px]:text-base">
                  What&apos;s Included
                </p>
                <ul className="space-y-3">
                  {PROFESSIONAL_FEATURES.map((item, i) => (
                    <li
                      key={i}
                      className="flex items-center gap-3 text-sm text-zinc-600 min-[2560px]:text-base"
                    >
            ...
            <div className="bg-white rounded-2xl p-8 sm:p-10 h-full flex flex-col relative overflow-hidden group border border-zinc-200 shadow-sm transition-all hover:shadow-lg hover:shadow-black/5">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="text-xl font-bold min-[2560px]:text-2xl">
                    Enterprise
                  </h3>
                </div>
                <p className="text-zinc-500 text-sm min-[2560px]:text-base">
