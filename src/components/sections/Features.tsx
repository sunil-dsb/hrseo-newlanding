            ...
            <div className="transition-all duration-300 flex flex-col items-center lg:items-start text-center lg:text-left features-content-center-4k">
              ...
              <BlurFade delay={0.2}>
                <h2 className="text-4xl md:text-5xl 2xl:text-6xl font-bold text-zinc-600 tracking-tighter mb-8 leading-[1.1]">
                  <TextHighlight className="text-black">
                    Everything
                  </TextHighlight>{" "}
                  you need to{" "}
                  <span className="block text-black">{activeTitle}</span>
                </h2>
              </BlurFade>
          ...
          <div className="lg:col-span-6 flex flex-col gap-6 features-grid-4k">
            {features.map((feature, index) => (
              <Link
                ...
                className={`group block h-full bg-white border p-8 rounded-xl transition-all duration-300 hover:shadow-xl hover:shadow-black/5 hover:border-[#F15A29]/30 ${
                  index === activeIndex
              ...
              >
                <div className="flex items-start gap-6 h-full">
                  ...
                  <m.div
                    className={`shrink-0 w-12 h-12 min-[2560px]:w-16 min-[2560px]:h-16 rounded-lg flex items-center justify-center transition-colors duration-300 ${
                      index === activeIndex
                        ? "bg-[#F15A29]/10 text-[#F15A29]"
                        : "bg-zinc-100 text-[#F15A29]"
                    }`}
                  ...
                  <div className="flex-1 flex flex-col h-full">
                    ...
                    <div
                      className="flex items-center gap-2 text-zinc-600 font-medium text-sm min-[2560px]:text-base opacity-80 group-hover:opacity-100 transition-opacity mt-auto"
                      aria-hidden="true"
                    >
