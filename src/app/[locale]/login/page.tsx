...
export default function LoginPage() {
          ...
          <div className="w-full lg:w-1/2 relative">
            ...
            >
              ...
              <div className="flex justify-between items-center mb-3">
                <h1 className="text-[12px] font-normal text-gray-700">Cannabis Lab</h1>
                <button className="text-sm font-normal text-gray-700 hover:text-gray-900 transition-colors">Sign up</button>
              </div>
  ...
  <span className="text-black font-normal text-xs sm:text-sm transition-colors group-hover:text-white">
    Facebook
  </span>
</button>
              ...
              <div className="mb-3">
                <div className="relative">
                  <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-6 h-6 sm:w-10 sm:h-10 rounded-full bg-white flex items-center justify-center">
                    {/* <Mail size={18} className="text-gray-700" />
       */}
                    <span className="text-sm sm:text-base font-bold text-gray-700">@</span>
                  </div>
                  <input
                    type="email"
              ...
              <div className="mb-6">
                <div className="relative">
                  <div className="absolute left-3 top-1/2 transform -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white flex items-center justify-center z-10">
                    <Lock size={13} className="sm:w-[15px] sm:h-[15px] text-gray-700" />
                  </div>
                  <input
                    type="password"
                    ...
                    className="w-full pl-12 sm:pl-14 pr-24 sm:pr-28 py-3 sm:py-3.5 rounded-full bg-[#e3dcd4] border-none placeholder-gray-800 focus:outline-none focus:ring-0 text-gray-800 font-normal text-sm sm:text-[12px]"
                  />
              ...
              <div className="space-y-4 ">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                  <p className="text-[8px] sm:text-[9px] w-full sm:w-3/4 mb-0 sm:mb-10 text-black-600 leading-relaxed font-light">
                    ...
                    accidental ingestion contact our <span className="underline cursor-pointer">hotline</span>.
                  </p>
                  <button className="relative w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-black flex items-center justify-center hover:bg-gray-900 transition-colors shadow-lg self-end sm:self-auto">
                    <span className="h-4 w-5 sm:h-5 sm:w-6 bg-black absolute rounded-l-full left-[-15px] sm:left-[-18px]" />
                    <ChevronRight size={20} className="sm:w-[20px] sm:h-[20px] text-white" strokeWidth={2.5} />
                  </button>
                </div>
                ...
                <p className="text-sm text-black-700   text-center">Please consume responsibly!</p>
              </div>
            </div>
            ...
            >
              <h3 className="text-[25px] sm:text-[30px] lg:text-[32px] font-bold text-white mb-2 leading-tight">New in</h3>
              <p className="text-gray-400 font-normal text-[16px] sm:text-[18px] lg:text-[20px] mb-auto">C.Lab Joints</p>
          ...
          <div className="hidden lg:block relative w-full lg:w-1/2" >
            <div className="relative shadow-white lg:absolute z-20 lg:h-[95%] w-full lg:w-1/2 backdrop-blur-2xl rounded-[20px] sm:rounded-[24px] lg:rounded-[32px] p-4 sm:p-5 border border-white/50 shadow-2xl flex flex-col my-3 mx-0 lg:mx-2 justify-between" style={{
              ...
              <div className="flex flex-col">
                {/* Date Display */}
                <div >
                  <h1 className="text-[50px] sm:text-[60px] lg:text-[70px] pb-2 text-gray-800 leading-none">Thu</h1>
                  <p className="text-[42px] sm:text-[52px] lg:text-[60px] text-gray-400 leading-none -mt-2 sm:-mt-3">24th</p>
                </div>

                {/* Event Details */}
              </div>
                <div className="space-y-1">
                  <p className="text-sm sm:text-base font-normal text-gray-800">18 PM</p>
                  <p className="text-sm sm:text-base font-normal text-gray-800">Kerkstraat 12B</p>
                  <p className="text-sm sm:text-base font-normal text-gray-800">Amsterdam</p>
                </div>
              ...
              <div className="flex flex-col items-start">
                ...
                <p className="text-xs sm:text-sm font text-gray-800">C.Lab</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="relative z-10 p-4 sm:p-5 h-full flex flex-col justify-between min-h-[400px] lg:min-h-[530px]">
                ...
                <div className="text-right self-end">
                  ...
                  <p className="text-xs sm:text-sm font-normal text-gray-800">New store</p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row justify-end items-end gap-3 sm:gap-0">
                  ...
                  {/* Join in Button */}
                  <button className="px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-black flex items-center gap-2 hover:bg-gray-900 transition-colors shadow-lg">
                    <span className="text-white font-normal text-xs sm:text-sm">Join in</span>
                  ...
                  <button className="relative w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-black flex items-center justify-center hover:bg-gray-900 transition-colors shadow-lg">
                    ...
                    <ChevronRight size={20} className="sm:w-[22px] sm:h-[22px] text-white" strokeWidth={2.5} />
                  </button>
                </div>
              </div>
            </div>
