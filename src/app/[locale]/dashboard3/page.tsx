  ...
  gaugeSlices.push({
    ...
    fill:
      i < activeSlices
        ? i < activeSlices - 4
          ? "#2563EB"
          : "#93C5FD" // Gradient simulation: Dark blue to light blue
  ...
  return (
    <div
      className={cn(
        ...
        active
          ? "bg-[#3B82F6] text-white shadow-blue-200 shadow-xl"
          : "bg-white text-gray-900 shadow-sm",
      )}
    >
      {/* Background blobs for active card */}
      {active && (
        <>
          {/* Top Right Blob */}
          <div className="absolute -top-12 -right-12 w-48 h-48 bg-[#60A5FA] rounded-full blur-3xl opacity-40 pointer-events-none mix-blend-screen"></div>
          {/* Bottom Left Blob */}
          <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-[#2563EB] rounded-full blur-2xl opacity-40 pointer-events-none mix-blend-multiply"></div>
        </>
      )}
              ...
              <span
                className={cn(
                  ...
                  active
                    ...
                    : trendUp
                      ? "bg-blue-50 text-blue-600" // Image has blue pills for positive on white cards usually? checking... Total Sales has blue pill. New Customer has blue pill.
        ...
        <main className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <button className="flex items-center gap-2 px-6 py-2.5 bg-[#3B82F6] rounded-full text-sm font-semibold text-white hover:bg-blue-600 shadow-lg shadow-blue-500/30 transition-all active:scale-95">
