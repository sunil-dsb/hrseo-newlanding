...
export default function Dashboard20() {
  return (
    <div className="flex min-h-screen font-sans text-gray-900">
      ...
      <aside className="fixed left-0 top-0 h-screen w-[72px] flex flex-col items-center pt-[130px] pb-6 bg-[#f4f5f7] z-50">
        {/* Hamburger Menu - positioned at welcome section level */}
        <div className="absolute top-[74px] left-1/2 -translate-x-1/2">
          <div className="w-10 h-10 flex flex-col items-center justify-center gap-[5px] rounded-full cursor-pointer">
            <div className="w-[18px] h-[2px] bg-gray-600"></div>
            <div className="w-[18px] h-[2px] bg-gray-600"></div>
            <div className="w-[18px] h-[2px] bg-gray-600"></div>
          </div>
        </div>
        ...
        <div className="mt-auto">
          <SidebarIcon icon={CornerDownLeft} />
        </div>
      </aside>
      ...
      <main className="pl-[72px] w-full">
        ...
        <div className="px-10 pb-8">
          ...
          <div className="flex justify-between items-end mb-6">
            ...
            <div className="flex items-center gap-3">
              <button className="px-5 py-2.5 bg-white text-gray-600 rounded-full flex items-center gap-2 text-sm font-medium border border-gray-100 hover:bg-gray-50">
                <Filter size={16} strokeWidth={1.5} /> Filters
              </button>
              <button className="px-5 py-2.5 bg-white text-gray-600 rounded-full flex items-center gap-2 text-sm font-medium border border-gray-100 hover:bg-gray-50">
                <Download size={16} strokeWidth={1.5} /> Exports
              </button>
              <button className="px-5 py-2.5 bg-[#F15A29] text-white rounded-full flex items-center gap-2 text-sm font-semibold hover:bg-[#d64a1d] transition-colors">
          ...
          <div className="flex gap-5">
            ...
            <div className="w-[380px] flex flex-col gap-4 shrink-0">
              ...
              <div className="bg-[#f8f7f5] rounded-[28px] p-5 flex flex-col">
                {/* Header Row */}
                <div className="flex justify-between items-start mb-5">
                  ...
                  <button className="px-3 py-1.5 bg-white text-gray-700 rounded-full text-[11px] font-medium flex items-center gap-1 border border-gray-100 shadow-sm">
                    Weekly <ChevronDown size={11} />
                  </button>
                </div>

                {/* Inner White Card with Total Income/Paid */}
            ...
            <div className="flex-1 flex flex-col gap-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                {/* Receipts Card */}
                <div className="bg-white p-5 rounded-[24px] flex flex-col justify-between h-[180px]">
                  <div>
                ...
                {/* Owes Card (Dark) */}
                <div className="bg-[#3d2c23] p-5 rounded-[24px] flex flex-col justify-between h-[180px] relative overflow-hidden">
