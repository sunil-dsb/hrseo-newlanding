...
import { BackgroundGradientAnimation } from "@/components/layout/background-animated-gradient";
import {
  Menu,
  Search,
  Calendar,
  ...
  return (
    <div className="min-h-screen w-full">
      <div className="p-6 w-full h-full">
        {/* Main Container */}
        <div className="max-w-[95vw] mx-auto bg-zinc-100 backdrop-blur-2xl rounded-3xl p-8">
          {/* Header */}
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-3 flex flex-col gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-5">
                ...
                <button className="w-full flex items-center justify-center gap-2 text-gray-400 hover:text-gray-600 transition-colors">
              ...
              <div className="bg-white border border-gray-200 rounded-2xl p-5">
                ...
                <div className="text-2xl font-bold text-gray-900">$ 26.00</div>
              </div>
            ...
            <div className="col-span-3 flex flex-col gap-6">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-2xl p-6">
                ...
                <p className="text-base text-gray-400">Just ask me anything!</p>
